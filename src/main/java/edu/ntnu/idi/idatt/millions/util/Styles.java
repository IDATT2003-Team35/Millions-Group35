 ...
 *
 * <p>Popup scenes do not inherit stylesheets from the main scene, so any
 * scene that should look like the rest of the application must explicitly
 * load {@code /styles.css}. This class centralizes that loading so the
 * stylesheet path lives in one place.</p>
 */
public final class Styles {
  ...
  /**
   * Adds the project stylesheet to the given scene if it is not already
